        ...
        <nav class="navtop shadow-sm shadow-sm">
            <div class="menuactions">
                <div class="input-group col-lg-12 d-flex flex-nowrap">
                    <div class="ms-3">
                        <input id="search-input" type="search" id="form1" class="form-control bg-light border border-0"
                            placeholder="Search" />
                    </div>
        ...
        <div class="finaltimetable">
            ...
            <form role="form" class="form" id="main_form">
                <table class="table table-hover table-striped align-middle mb-0 bg-white">
                    ...
                    <tbody>
                        <tr>
                            <td><input type="text" class="no-border" placeholder="Unit Code" id="session_time"
                                    name="session_time" class="form-control rounded-0" required />
                            </td>
                            <td><input type="text" class="no-border" placeholder="Lecturer" id="session_time"
                                    name="session_time" class="form-control rounded-0" required />
                            </td>
                            <td id="days"><input type="text" class="no-border" placeholder="Unit Code" id="session_time"
                                    name="session_time" class="form-control rounded-0" required />
                            </td>
                            <td id="timeshifts"><input type="text" class="no-border" placeholder="Lecturer"
                                    id="session_time" name="session_time" class="form-control rounded-0" required />
                            </td>
                            <td id="venues"><input type="text" class="no-border" placeholder="Unit Code"
                                    id="session_time" name="session_time" class="form-control rounded-0" required />
                            </td>
                ...
                <div class="form-group">
                    <input type="button" onclick="addSetting('main')" class="btn btn-primary form-control" value="Add"
                        name="add_main" />
                </div>
            </form>
